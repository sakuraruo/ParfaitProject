;(function($){
	...
	window[fnName] = function(setConfig){
		...
		$(".dropdown-menu li").click(function(){
			var str=$(this).text();
			$("#searchFor").html(str+"<span class='caret'></span>");
			$("#searchFor").attr("selectValue",str);
		});
		
		$(".m li").click(function(){
			var str=$(this).text();
			$("#searchForin").html(str+"<span class='caret'></span>");
		});
...
//	添加鼠标移入移出事件
//	$(".ply-icon").mouseover(function(){
//		$(".ply-icon").css("background","url(../img/footer/table.png) repeat-x 0px  -128px");
//	});
//	$(".ply-icon").mouseout(function(){
//		$(".ply-icon").css("background","url(../img/footer/table.png) repeat-x 0px  -105px");
//	});
//	function MouseOver(obj)
//    {
//        obj.css("background","url(../img/footer/table.png) repeat-x 0px  -128px");
//    }
//     
//    function MouseOut(obj)
//    {
//        obj.css("background","url(../img/footer/table.png) repeat-x 0px  -105px");
//    }
