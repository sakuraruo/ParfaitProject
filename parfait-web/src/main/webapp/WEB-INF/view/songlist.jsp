...
<script src="../js/jquery-3.2.1.min.js"></script>
	...
	<body>
		...
		<div class="bg" style="height: 638px;">
			<div id="my_music" style="height: 502px;width: 930px;margin-left: 180px;margin-right:180px;">
				<!--个人歌单-->
								...
								<div style="width: 400px;height: 208px;margin-right: 80px;margin-top: 10px; padding: 2px 2px 2px 2px;float: right;">
									<div style="height: 24px;width: 100%;margin-top: 10px;">
   									...
   									歌单
										...
										<h2>WHITE ALBUM2 ORIGINAL SOUNDTRACK～kazusa～</h2>
									</div>
									<div style="height: 35px;width: 100%;margin-top: 30px;margin-bottom: 10px;">
										<a style="float: left;">
   								...
   								<p>发行公司： AQUAPLUS</p>
									...
									<div style="margin-top: 5px;">
										<p style="float:left;color: #000000;">
											<b style="float: left;">歌单介绍：</b> 「アクアプラス作品キャラクター人気投票」で女性キャラクター1位に輝いた「冬馬かずさ」の「ヴォーカルCD」発売を記念して、オンリーセットを販売いたします！
										</p>
									</div>
					...
					<div id="song_list">
						<table id="music_table">
							<thead>
								...
								<th>
									<div style="background: url(../img/footer/table.png) repeat-x 0px 5px ;width: 283px;height: 34px;text-align: center;color: #000000;margin-left: 2px; ">歌曲标题</div>
								</th>
								<th>
									<div style="background: url(../img/footer/table.png) repeat-x 0px 5px ;width: 111px;height: 34px;text-align: center;color: #000000;margin-left: 2px;  ">时长</div>
								</th>
								<th>
									<div style="background: url(../img/footer/table.png) repeat-x 0px 5px ;width: 103px;height: 34px;text-align: center;color: #000000;margin-left: 2px;  ">歌手</div>
								</th>
								<th>
									<div style="background: url(../img/footer/table.png) repeat-x 0px 5px ;width: 231px;height: 34px;text-align: center;color: #000000;margin-left: 2px;  ">专辑</div>
								</th>
							</thead>
							<tbody class="music_table">
								<tr>
									...
									<td>
										<div style="float: left;color: #0F0F0F;text-align: center;width: 100%;height: 100%;">
											<a>White Album</a>
										</div>
									</td>
									<td>
									...
									<td>
										<div style="float: left;color: #0F0F0F;text-align: center;width: 100%;height: 100%;">
											<a>WHITE ALBUM2 ORIGINAL SOUNDTRACK～kazusa～</a>
										</div>
									</td>
								</tr>
								<tr>
							...
							<div style="float: left;margin-left: 50px;text-align: left;">
								<div>
									...
									<div style="float: left;text-align: left;">
										<HR style="border:1 dashed #987cb9;" width="680px" color=#987cb9 SIZE=1>
									</div>
								</div>
								<div>
									<div>
